  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`https://${URL}/api/images/${id}`);
        ...
        if (response.data.resources.length > 0) {
          ...
          const pastWeatherResponse = await axios.get(`https://${URL}/api/weather/${latitude}/${longitude}/${date}`);
          ...
          const currentWeatherResponse = await axios.get(`https://${URL}/api/currentweather/${latitude}/${longitude}`);
